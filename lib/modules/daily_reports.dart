...
class DailyReports extends StatelessWidget {
  DailyReports({Key? key}) : super(key: key);
                ...
                Expanded(
                   child: Directionality(
                    ...
                    child: GridView.builder(
                      ...
                      gridDelegate:  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,childAspectRatio: 3.7 ,),
                      itemCount:cubit.drTitles.length,


                      itemBuilder: (context, index) => builtItem(
                          name: cubit.drTitles[index],
                          context: context,result:
                      cubit.drResult.length > index ? cubit.drResult[index]:cubit.isnull ),
